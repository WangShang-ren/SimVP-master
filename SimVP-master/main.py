...
def create_parser():
    ...
    parser.add_argument('--num_workers', default=0, type=int)#windows系统，将8改为0
    ...
    # Training parameters
    parser.add_argument('--epochs', default=2, type=int)#51改2
    parser.add_argument('--log_step', default=50, type=int)#1改50
